...
struct Node_s {
    void* item;		// The itme that the Node_s hold
    int index;		// The index of the Node_s in the Node_array
    Node* next;		// Pointer point to the next Node_s
    Node* prev;		// Pointer point to the previous Node_s
};

typedef struct {
	void* current_item;		// Current pointer
	int item_index;			// The index of the node which contains the current_item in the Node_array
	int count;  			// Number of nodes in the list
	int index;				// Index of the list in List_array
	Node* head;				// List head
	Node* tail;				// List tail
} List;
